...
public class PythonWorkerExecutorService {
    ...
    public String executePlaybook(String playbookFileName, String jsonPayload) throws Exception {
        ...
        if (!scriptFile.exists()) {
            // Fallback: try relative to working directory or absolute
            File absoluteScriptFile = new File(System.getProperty("user.dir"), pythonWorkersPath + File.separator + playbookFileName);
